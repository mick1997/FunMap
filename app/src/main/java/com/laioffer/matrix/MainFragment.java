...
public class MainFragment extends Fragment implements OnMapReadyCallback, ReportDialog.DialogCallBack,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        this.googleMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(
                getActivity(), R.raw.style_json));  // getContext is also ok
    ...
    private void uploadImage(final String key) {
        ...
        final StorageReference imageRef = storageRef.child("image/" + uri.getLastPathSegment() +
        ...
        database.child("events").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot noteDataSnapshot : dataSnapshot.getChildren()) {
                    ...
                    int distance = Utils.distanceBetweenTwoLocation(centerLatitude,
                    ...
                    if (distance < 20) {
                        ...
                        Bitmap resizeBitmap = Utils.getResizeBitmap(icon, 130, 130);
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        if (locationTracker != null) {
            distance = Utils.distanceBetweenTwoLocation(latitude, longitude,
                    locationTracker.getLatitude(), locationTracker.getLongitude());
        }
        mEventTextLocation.setText(String.format("%s miles away", distance));
